...
//}
//
//void removeElementFromAnySpecificPosition(Node*& head, int pos) {
...
//		cout << "Element removed from position 0." << endl;
//		elementOfNode(head);
//		return;
//	}
//
...
//	while (mov->next != nullptr && track < pos - 1) {
//		mov = mov->next;
//		track++;
//	}
//
//	// If we reached the end of the list or if the position is out of bounds
//	if (mov->next == nullptr) {
//		cout << "Position is out of bounds." << endl;
//		return;
//	}
...
//	Node* temp = mov->next;  // Store the node to be deleted
//	mov->next = temp->next;  // Link the previous node to the next node
//	delete temp;             // Delete the node
//
//	cout << "Element removed from position " << pos << endl;
//	elementOfNode(head);     // Print the list after removal
//}
//
//
//
...
//	removeElementFromAnySpecificPosition(head,2);
//	cout << head->data
//		 << endl;
////	cout << tail;
////		 << endl;
